...
export class ClienteComponentsPage {
    ...
    deleteButtons = element.all(by.css('jhi-cliente-farmatify div table .btn-danger'));
    title = element.all(by.css('jhi-cliente-farmatify div h2#page-heading span')).first();
...
export class ClienteUpdatePage {
    pageTitle = element(by.id('jhi-cliente-farmatify-heading'));
